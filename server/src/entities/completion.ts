...
export const completionKeysAll = Object.keys(completionSchema.shape) as (keyof Completion)[]

export const completionKeysPublic = completionKeysAll

export type CompletionPublic = Pick<Selectable<Completion>, (typeof completionKeysPublic)[number]>
