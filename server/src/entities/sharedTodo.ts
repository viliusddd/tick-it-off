...
export const sharedTodoKeysAll = Object.keys(sharedTodoSchema.shape) as (keyof SharedTodo)[]

export const sharedTodoKeysPublic = sharedTodoKeysAll

export type SharedTodoPublic = Pick<Selectable<SharedTodo>, (typeof sharedTodoKeysPublic)[number]>
